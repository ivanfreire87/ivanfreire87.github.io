...
function translate_to(lang){
	if(language == 'en'){
		...
		" systems and computer engineering. Interest in this area has awakened very early, when I had my first computer" +
		" and whenever there was a problem with it I always tried to solve it myself. I liked to change the source code of" +
		" web pages to see the changes taking place and made my first site at about 14 years of age. I've always been curious," +
		" eager to learn and I love challenges, always trying to be the best at what I do, both personally and professionally." +
		" These personal characteristics were reflected in my academic career because I had to learn most of the materials" +
		" alone while reconciling work with a course without an after-hours option. I enjoy working with others and I am always" +
	...
	/*************************PORTUGUESE**********************************/
		...
		" informática e de computadores. O interesse por esta área despertou muito cedo, quando tive o meu primeiro" +
		" computador e sempre que surgia algum problema com o mesmo eu tentava sempre resolvê-lo sozinho. Gostava de" +
		" alterar o código fonte de páginas web para ver as alterações que ocorriam e fiz o meu primeiro site por volta" +
		" dos 14 anos. Sempre fui curioso, com vontade de aprender e adoro desafios, tentando ser sempre o melhor possível" +
		" no que faço, tanto a nível pessoal como profissional. Estas características pessoais reflectiram-se no meu percurso" +
		" académico pois, uma vez que este curso não disponibilizava regime pós-laboral, tive de aprender a maior parte das" +
		" matérias sozinho enquanto conciliava o mesmo com o trabalho."
    ...
    " notícias da empresa, verificar o valor actual do cartão de refeição, marcar ausências e verificar se as mesmas foram aceites" +
		...
		document.getElementById("contacts-title").innerHTML = "Contactos"
